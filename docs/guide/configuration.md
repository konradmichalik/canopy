---
title: Configuration
description: Jira connection and credential settings
---
...
See [Installation Guide](/getting-started/installation#cors-proxy) for proxy setup instructions.
...
See [Troubleshooting](/reference/troubleshooting) for common connection issues and solutions.
